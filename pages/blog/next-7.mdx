...
<Image src="/static/blog/next-7/webpackbar.gif" width={1734/2} height={880/2} />
...
<Image src="/static/blog/next-7/errors.png" width={1490/1.5} height={538/1.5} caption="The previous overlay left, react-error-overlay right" />
...
**Note:** this upgrade is **fully backwards-compatible**. Hoever, if you are using custom webpack loaders or plugins via [next.config.js](/docs#customizing-webpack-config), you might have to upgrade them.
...
For a full list of changes, you can refer to Babel its [release notes](http://babeljs.io/blog/2018/08/27/7.0.0http://babeljs.io/blog/2018/08/27/7.0.0).
...
<Image src="/static/blog/next-7/homepage.png" width={2466/2.5} height={1698/2.5} caption="The new nextjs.org" />
...
<Image src="/static/blog/next-7/showcase.png" width={2466/2.5} height={1698/2.5} caption="Get inspired on nextjs.org/showcase" />
...
The Next.js community on [spectrum.chat/next-js](https://spectrum.chat/next-js) has nearly 2000 members. [Join us!](https://spectrum.chat/next-js)!

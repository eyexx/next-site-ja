...
export const meta = {
  ...
  twitterCard: 'https://assets.zeit.co/image/upload/front' + '/blog/next6-1/twitter-card.png'
}
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6-1/server-dist.png'} width={1574/3} height={754/3} />
<Caption>The pre-rendering files are now in the <Caption.Code>server</Caption.Code> directory</Caption>
...
```
<Caption>How the pathname should be accessed in versions after Next.js 6 using <Caption.Code>router</Caption.Code> injected by <Caption.Code>withRouter</Caption.Code></Caption>
...
<Caption>This will transform uses of <Caption.Code>url</Caption.Code> to <Caption.Code>withRouter</Caption.Code>. <GenericLink href="https://github.com/zeit/next-codemod#url-to-withrouter">Read more here</GenericLink></Caption>
...
- Joining the community and giving advice on [spectrum.chat/next-js](https://spectrum.chat/next-js)
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6-1/good-first-issue.png'} width={1968/3} height={1468/3} />
<Caption>There's 30 open issues with the <GenericLink href="https://github.com/zeit/next.js/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22good+first+issue%22">good first issue</GenericLink> label. Giving new contributors the opportunity to contribute.</Caption>

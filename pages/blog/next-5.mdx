...
export const meta = {
  ...
  link: '/blog/next-5',
  twitterCard: `https://assets.zeit.co/image/upload/front/blog/next5/twitter-card.png`
}
...
<Caption>In addition to bumping Next.js, we upgrade the peer dependencies <Caption.Code>react</Caption.Code> and <Caption.Code>react-dom</Caption.Code></Caption>
...
```
<Caption>An example of the optional <Caption.Code>next.config.js</Caption.Code> file</Caption>
...
```
<Caption>An example page (<Caption.Code>pages/index.js</Caption.Code>) using CSS imports thanks to Universal Webpack</Caption>
...
```
<Caption>Extending the raw webpack config gives you great flexibility and control</Caption>
...
```
<Caption>All it takes to enable importing <Caption.Code>.css</Caption.Code> files is to bring in <Caption.Code>next-css</Caption.Code></Caption>
...
<Table>
  <Row>
    <Cell><b>CSS</b></Cell>
    <Cell><GenericLink href="https://github.com/zeit/next-plugins/tree/master/packages/next-css">next-css</GenericLink></Cell>
  </Row>
  <Row>
    <Cell><b>LESS</b></Cell>
    <Cell><GenericLink href="https://github.com/zeit/next-plugins/tree/master/packages/next-less">next-less</GenericLink></Cell>
  </Row>
  <Row>
    <Cell><b>SASS</b></Cell>
    <Cell><GenericLink href="https://github.com/zeit/next-plugins/tree/master/packages/next-sass">next-sass</GenericLink></Cell>
  </Row>
</Table>
...
already get full TypeScript support *today*!
...
```
<Caption>All we have to do is enable the <Caption.Code>ts-loader</Caption.Code></Caption>
...
```
<Caption>Our new <Caption.Code>next.config.js</Caption.Code> ready for preact</Caption>
...
```
<Caption>We simply configure the <Caption.Code>devtool</Caption.Code> option differently when not in development</Caption>
...
<Image
  src={`${'https://assets.zeit.co/image/upload/front'}/blog/next5/zones.png`}
  width={4354/4}
  height={1456/4}
...
<GenericLink href="https://github.com/zeit/docs/pull/113"><Image
  src={`${'https://assets.zeit.co/image/upload/front'}/blog/next5/github.png`}
  width={1632/2.5}
  height={610/2.5}
  caption={<Fragment><br />Every time a change happens inside a PR our bot automatically deploys it</Fragment>}
/></GenericLink>
...
<Image
  src={`${'https://assets.zeit.co/image/upload/front'}/blog/next5/build.png`}
  width={2956/2.68}
  height={896/2.68}
  caption={<Fragment>Our main application production build now takes <strong>38 fewer seconds</strong> to complete</Fragment>}
/>
...
```
<Caption><Caption.Code>Document</Caption.Code> allows you to customize the entire server-rendered output of a page</Caption>
...
<Image
  src={`${'https://assets.zeit.co/image/upload/front'}/blog/next5/errors.png`}
  width={4354/4}
  height={1056/4}

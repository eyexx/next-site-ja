...
export const meta = {
  ...
  link: '/blog/next-6',
  twitterCard: 'https://assets.zeit.co/image/upload/front' + '/blog/next6/twitter-card.png'
}
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6/page-transitions.png'} width={1356/2} height={850/2} />
...
<Video
  src="https://assets.zeit.co/video/upload/v1526251206/front/blog/next6/hnpwa.mp4"
  width={1220/1.5}
  height={524/1.5}
/>
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6/docs.png'} width={2662/3} height={1648/3} />
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6/learn.png'} width={2662/3} height={1648/3} />
...
<Image src={'https://assets.zeit.co/image/upload/front' + '/blog/next6/showcase.png'} width={2558/3} height={1578/3} />

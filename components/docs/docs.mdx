...
<ul>
  ...
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-glamorous">Glamorous</a></li>
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-prefetching">Prefetching</a></li>
</ul>
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-dynamic-import">With Dynamic Import</a></li>
</ul>
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-app-layout">Using `_app.js` for layout</a></li>
</ul>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-componentdidcatch">Using `_app.js` to override `componentDidCatch`</a></li>
</ul>
...
- Commonly used to implement server side rendering for css-in-js libraries like [styled-components](https://github.com/zeit/next.js/tree/canary/examples/with-styled-components), [glamorous](https://github.com/zeit/next.js/tree/canary/examples/with-glamorous) or [emotion](https://github.com/zeit/next.js/tree/canary/examples/with-emotion). [styled-jsx](https://github.com/zeit/styled-jsx) is included with Next.js by default.
...
`phase` is the current context in which the configuration is loaded. You can see all phases here: [constants](https://github.com/zeit/next.js/blob/master/lib/constants.js).
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-webpack-bundle-analyzer">Custom webpack bundle analyzer</a></li>
</ul>
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-custom-babel-config">Custom babel configuration</a></li>
</ul>
...
<b>Examples</b>
<ul>
  <li><a href="https://github.com/zeit/next.js/tree/canary/examples/with-zones">With Zones</a></li>
</ul>
